// Note: Pagination now handled by tiptap-pagination-plus extension
...
export { TextAnalysisDecorations, type TextAnalysisDecorationsOptions } from './TextAnalysisDecorations'
